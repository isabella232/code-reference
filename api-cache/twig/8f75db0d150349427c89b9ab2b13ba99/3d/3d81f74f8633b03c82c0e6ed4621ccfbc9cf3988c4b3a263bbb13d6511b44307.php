...
/* function.html.twig */
class __TwigTemplate_a64493a146ac3781a0ea412af43ddc20dde2fa330fc71d1a09b7c876f00cdf7b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
>
    ...
    ";
        // line 59
        $context["visibleTags"] = twig_array_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["function"] ?? null), "tags", [], "any", false, false, false, 59), function ($__v__, $__k__) use ($context, $macros) { $context["v"] = $__v__; $context["k"] = $__k__; return !twig_in_filter(($context["k"] ?? null), [0 => "param", 1 => "return", 2 => "package"]); });
        // line 60
        echo "    ";
